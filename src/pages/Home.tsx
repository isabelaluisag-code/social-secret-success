    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b border-border bg-card/90 backdrop-blur-md">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
          <img src={logoImplementare} alt="Implementare" className="h-7 w-auto" />
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-lg w-full space-y-4">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-1">Implementare Gestão</h1>
      ...
      <footer className="text-center py-4 text-xs text-muted-foreground border-t border-border font-body">
        Documento interno — Implementare Gestão
      </footer>
    </div>
  );
};
